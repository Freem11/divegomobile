...
const prodAwsAccountId = process.env.EXPO_PUBLIC_AWS_R2_ACCOUNT_ID;
const prodAwsAccessKeyId = process.env.EXPO_PUBLIC_AWS_R2_ACCESS_KEY_ID;
const prodAwsSecretKey = process.env.EXPO_PUBLIC_AWS_R2_SECRET_KEY;

const devAwsAccountId = process.env.EXPO_PUBLIC_AWS_R2_DEV_ACCOUNT_ID || process.env.AWS_R2_ACCOUNT_ID;
const devAwsAccessKeyId = process.env.EXPO_PUBLIC_AWS_R2_DEV_ACCESS_KEY_ID || process.env.AWS_R2_ACCESS_KEY_ID;
const devAwsSecretKey = process.env.EXPO_PUBLIC_AWS_R2_DEV_SECRET_KEY || process.env.AWS_R2_SECRET_KEY;
